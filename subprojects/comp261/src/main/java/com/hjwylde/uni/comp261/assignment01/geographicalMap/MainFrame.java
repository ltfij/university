...
public class MainFrame extends JFrame {
    ...
    private JMenuItem miLoadNodes, miLoadRoadRestrictions, miLoadRoads, miLoadRoadSegments;
    ...
    private JRadioButtonMenuItem miTravelAny, miTravelCar, miTravelPedestrian, miTravelBicycle;
    ...
    private void initMenuBar() {
        ...
        miAstar.setSelected(geographicalMap.getSearchMethod() == GeographyMap.SEARCH_ASTAR);
        ...
        miDijkstras.setSelected(geographicalMap.getSearchMethod() == GeographyMap.SEARCH_DIJKSTRA);
        ...
        miTravelAny.setSelected(geographicalMap.getTravelMethod() == GeographyMap.TRAVEL_ANY);
        ...
        miTravelCar.setSelected(geographicalMap.getTravelMethod() == GeographyMap.TRAVEL_CAR);
