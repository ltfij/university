 ...
 * 
 * Note: A 2d <code>Polytope</code> is also referred to as a Polygon or a Face.
 * 
...
public interface Polytope extends Cloneable {
     ...
     * the camera as the camera is looking down the z-axis. Safer to use a value that is 1 pixel
     * away from the camera such as -1.0 rather than 0.0. Returns true if the <code>Polytope</code>
     * is visible after clipping.
     * 
     ...
     * camera.
     * 
     * Note: The <code>ScanConverter</code> holds the data for the <code>World3d</code>s light
     * sources and <code>ViewPlane</code>.
     * 
     * @param z the ZBuffer.
     * @param sc the ScanConverter.
     * 
     * @see com.hjwylde.uni.comp261.assignment04.graphics.ScanConverter
     * @see com.hjwylde.uni.comp261.assignment04.graphics.ViewPlane
     ...
     * 
     * Note: For rotation matrices transposing and inverting are the same thing.
     * 
     * @param m the rotation matrix.
     */
