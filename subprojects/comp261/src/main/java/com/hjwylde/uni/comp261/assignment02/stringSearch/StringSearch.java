 ...
 * http://www.fmi.uni-sofia.bg/fmi/logic/vboutchkova/sources/BoyerMoore_java.html I modified only
 * the variable names / format.
 */
    ...
    public static class BoyerMoore implements StringSearch {
        ...
        private static int[] generateSuffix(CharSequence needle) {
            ...
            for (int i = suffix.length - 2; i >= 0; i--) {
                while ((j < (suffix.length - 1)) && (needle.charAt(j) != needle.charAt(i)))
                    j = suffix[j + 1] - 1;
