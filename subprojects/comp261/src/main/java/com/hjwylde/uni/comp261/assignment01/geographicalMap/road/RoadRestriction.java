...
public class RoadRestriction {
    ...
    public RoadRestriction(int fromNID, int fromRID, int midNID, int toRID, int toNID) {
    ...
    public String toString() {
        return "RoadRestriction [fromNID=" + fromNID + ", fromRID=" + fromRID + ", midNID="
                + midNID + ", toNID=" + toNID + ", toRID=" + toRID + "]";
    }
}
