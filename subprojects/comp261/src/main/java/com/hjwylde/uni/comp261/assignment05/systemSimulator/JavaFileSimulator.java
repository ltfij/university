...
public class JavaFileSimulator {
    ...
    public static void main(String[] args) {
        ...
        bBasicOpen.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean createIfDoesNotExist =
                        JOptionPane.showConfirmDialog(null, "Create file if it does not exist?",
                                "Create File?", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
                if (basicFile.open(fileName, createIfDoesNotExist)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Cannot open the basic file!", "Error",
        ...
        bBasicWrite.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                String data = JOptionPane.showInputDialog("Enter characters to write:");
                if (data.indexOf('~') != -1) {
                    JOptionPane.showMessageDialog(null,
                            "Input CANNOT contain end of file character: " + +'~', "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                if (!basicFile.write(data.toCharArray()))
                    JOptionPane.showMessageDialog(null, "Error writing to the basic file!",
        ...
        bBasicRead.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                do {
                    String readNumChars =
                            JOptionPane.showInputDialog("Enter number of characters to read:");
                ...
                if (basicFile.read(data))
                    ...
                    JOptionPane.showMessageDialog(null, "Read: " + new String(data),
                            "Read As Follows", JOptionPane.INFORMATION_MESSAGE);
                else
                    JOptionPane.showMessageDialog(null, "Error reading from the basic file!",
                            "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        bBasicSeek.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (basicFile.seek(seekForwardFromCurrent)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Error seeking in the basic file!",
                            "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        bBasicClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (basicFile.close()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Error closing the file!", "Error",
                            JOptionPane.ERROR_MESSAGE);
            }
        });
        bBasicClose.setEnabled(false);
        ...
        bSequentialOpen.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (sequentialFile.open(fileName, createIfDoesNotExist)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Cannot open the sequential file!",
                            "Error", JOptionPane.ERROR_MESSAGE);
        ...
        bSequentialWrite.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String name =
                        JOptionPane.showInputDialog("Please input a name (up to 15 letters):");
                if (name == null)
                    return;

                if (name.length() > 15) {
                    JOptionPane.showMessageDialog(null,
                            "Name should've less than or equal to 15 letters!", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                String grade = JOptionPane.showInputDialog("Please input a grade (one letter):");
                if (grade == null)
                    return;
                if (grade.length() != 1) {
                    JOptionPane.showMessageDialog(null, "Grade should've been 1 letter!", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                String id = JOptionPane.showInputDialog("Please enter ID between 0 and 999:");
                if (id == null)
                    return;
                int idN;
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "ID should've been a number!", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                if ((idN < 0) || (idN > 999)) {
                    JOptionPane.showMessageDialog(null, "ID should've been in 0 - 999 range!",
                            "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (sequentialFile.write(r))
                    ...
                    JOptionPane.showMessageDialog(null, "Error writing to the sequential file!",
                            "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        bSequentialFind.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (r != null)
                    // File read from successfully.
                    JOptionPane.showMessageDialog(null,
                            "ID: " + r.id + " Name: " + String.valueOf(r.name) + " Grade: "
                                    + String.valueOf(r.grade), "Read As Follows",
                            JOptionPane.INFORMATION_MESSAGE);
                else
                    JOptionPane.showMessageDialog(null, "Error finding in the sequential file!",
                            "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        bSequentialDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (sequentialFile.delete(idN))
                    ...
                    JOptionPane.showMessageDialog(null, "Error deleting from the sequential file!",
                            "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        bHeapOpen.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (heapFile.open(fileName, createIfDoesNotExist)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Cannot open the heap file!", "Error",
                            JOptionPane.ERROR_MESSAGE);
        ...
        bHeapFind.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (r != null)
                    ...
                    JOptionPane.showMessageDialog(null, "Error finding in the heap file!", "Error",
                            JOptionPane.ERROR_MESSAGE);
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (chooser.showOpenDialog(frame) == JFileChooser.APPROVE_OPTION)
                    if (disk.loadDisk(chooser.getSelectedFile().getPath())) {
                        ...
                        JOptionPane.showMessageDialog(null, "Cannot open the disk!", "Error",
                                JOptionPane.ERROR_MESSAGE);
            }
        });
        menu.add(miLoadDisk);
