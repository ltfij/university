package com.hjwylde.uni.comp261.util;

import java.awt.*;
import java.io.File;

/**
 * A DrawingCanvas is an area for drawing shapes, text, and images. It uses
...
public class DrawingCanvas extends Canvas {
    ...
    /**
     * Clear the canvas area. With an argument of false, do not redisplay the
     * canvas yet.
     */
    ...
    /**
     * Clear the rectangular region with left edge at <I>x</I>, top edge at <I>y</
     * I> of <I>width</I> and <I>height</I>.<BR>
    ...
    /**
     * Draw an arc of an oval (outline or filled) The left edge of the oval would
     * be at <I>x</I>, top edge at <I>y</I> of <I>width</I> and <I>height</I>.The
     * arc begins at <I>startAngle</I> and extends for <I>arcAngle</I> degrees.<BR>
     * Angles are interpreted such that 0 degrees is at the 3 o'clock position. A
    ...
    /**
     * Load the image from <I>name</I> and draw it with left edge at <I>x</I>, top
     * edge at <I>y</I> scaled to <I>width</I> and <I>height</I>.
     */
    ...
    public void drawImage(String name, int x, int y, int width, int height,
        ...
        if (fh.canRead()) {
            ...
            imgGraphic.drawImage(img, x, y, width, height, getBackground(),
                this);
        } else {
    ...
    /**
     * Draw an oval (outline or filled) with left edge at <I>x</I>, top edge at <I
     * >y</I> of <I>width</I> and <I>height</I>.<BR>
     * With a fifth argument of <I>false</I>, do not redisplay the canvas yet.
     */
    ...
    /**
     * Draw a rectangle (outline or filled) with left edge at <I>x</I>, top edge
     ...
     * programs can do more complicated operations on the image than are provided
     * by this class. <BR>
     * Standard usage would be to get the graphics object, call methods on it, and
     * then call the display() method on the DrawingCanvas to update the visible
     * imagewith the modifications.
     */
    ...
    public Dimension getPreferredSize() {
        return new Dimension(Math.min(640, DrawingCanvas.MaxX), Math.min(480,
            DrawingCanvas.MaxY));
    }
    ...
    /**
     * Invert the rectangular region with left edge at <I>x</I>, top edge at <I>y<
     * /I>of <I>width</I> and <I>height</I>. <BR>
     * With a fifth argument of <I>false</I>, do not redisplay the canvas yet.
     */
    ...
    /**
     * Set the current foreground color - the color that all subsequent shapes or
     * text
     */
    ...
    public void setFontSize(int size) {
        imgGraphic
            .setFont(new java.awt.Font("Arial", java.awt.Font.PLAIN, size));
    }
