...
public class ZBuffer {
     ...
     * the pixel if the depth <code>z</code> is less (closer towards the camera) than the current
     * recorded depth. Updates the depth[][] array if the pixel is set.
     * 
    ...
    public void set(int x, int y, double z, Color color) {
        if ((x < 0) || (x >= width) || (y < 0) || (y >= height) || (color == null)) // If (x, y) is
                                                                                    // not
                                                                                    // within
                                                                                    // bounds...
            return; // ... return.
