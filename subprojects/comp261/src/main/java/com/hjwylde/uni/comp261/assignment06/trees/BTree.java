...
/*
 * Code for Assignment 6, COMP 261 Name: Henry J. Wylde Usercode: wyldehenr ID: 300224283
 */

public class BTree implements Iterable<BTree.Record> {

    /**
     * Order = 2m + 1. The order of the BTree is the maximum number of children it may have.
     */
     ...
     * the maximum number of records a node may contain. Must be an even number and greater than 0.
     * 
     ...
     * the tree if it doesn't already exist.
     * 
     * @param id the record id.
    ...
    private class Node {
        ...
        public Node delete(int id) {
            ...
            if (isLeaf()) {
                ...
                if ((size < (order / 2)) && !isRoot()) // If we have underflowed...
                    return parent.childUnderflow((size == 1 ? records[0].id : childId)); // ...tell
                                                                                         // the
                                                                                         // parent.
            } else { // !isLeaf()
        ...
        protected Node childUnderflow(int id) {
            ...
            if (neighbourPos == (pos + 1)) { // Using right neighbour.
                ...
                merge.records[child.size] = records[pos]; // Add the parent record to the merge
                                                          // node.
                System.arraycopy(neighbour.records, 0, merge.records, child.size + 1,
                        neighbour.size); // Add the neighbour records to the merge node.
                ...
                if (!child.isLeaf()) {
                    ...
                    for (int i = 0; i < (neighbour.size + 1); i++)
                        merge.setChild(child.size + 1 + i, neighbour.children[i]); // Add the
                                                                                   // neighbour
                                                                                   // children to
                                                                                   // the merge
                                                                                   // node.
                ...
                if ((size < (order / 2)) && !isRoot())
                    return parent.childUnderflow((size == 1 ? records[0].id : childId));
                ...
                merge.records[neighbour.size] = records[neighbourPos]; // Add the parent record to
                                                                       // the
                                                                       // merge node.
                System.arraycopy(child.records, 0, merge.records, neighbour.size + 1, child.size); // Add
                                                                                                   // the
                                                                                                   // child
                                                                                                   // records
                                                                                                   // to
                ...
                if (!child.isLeaf()) {
                    ...
                    for (int i = 0; i < (neighbour.size + 1); i++)
                        merge.setChild(i, neighbour.children[i]); // Add the neighbour children to
                                                                  ...
                                                                  // node.
                    for (int i = 0; i < (child.size + 1); i++)
                        merge.setChild(neighbour.size + 1 + i, child.children[i]); // Add the child
                                                                                   // children
                                                                                   // to the merge
                                                                                   // node.
                }
        ...
        protected Node insert(Record r, Node right) {
            ...
            if (size == (order - 1)) { // If overflowed (ie, after inserting size = size + 1)...
                ...
                System.arraycopy(records, (size / 2) + 1, insertChild.records, 0, size / 2); // Copy
                                                                                             // half
                                                                                             // the
                                                                                             // records
                                                                                             // to
                                                                                             ...
                                                                                             // split
                                                                                             // child.
                records = Arrays.copyOf(Arrays.copyOfRange(records, 0, size / 2), order); // Set the
                                                                                          // records
                                                                                          // to
                                                                                          // (this
                                                                                          // left
                ...
                if (!isLeaf()) {
                    ...
                    insertChild.setChildren(Arrays.copyOf(
                            Arrays.copyOfRange(children, (size / 2) + 1, children.length),
                            order + 1)); // Copy half the
                                         // children to the
                                         // right split
                                         // child.
                    Arrays.fill(children, (size / 2) + 1, children.length, null); // Clear the
                                                                                  // children just
                    // copied.
                }
         ...
         * Clears all inbetween / after elements to null after shuffling.
         * 
        ...
        private void shuffle(Object[] src, int from, int to) {
            System.arraycopy(src, from, src, to, src.length - Math.max(from, to));
