package com.hjwylde.uni.comp422.project01.question01_1;
...
public final class Main {
    ...
    private static final String SOURCE_IMAGE_PATH =
            "/project01/question01_1/test-pattern." + FORMAT;
    private static final String DESTINATION_IMAGE_PATH =
            "out/project01/question01_1/test-pattern." + FORMAT;
    ...
    public static void main(String[] args) throws IOException {
        ...
        result = Image.applySobelOperation(result);
