...
public class InterpreterTests {
    ...
    /**
     * Some simple tests that shape difference is working. You will want to add more of your own
     * tests!
     */
    @Test
    ...
    /**
     * Some simple tests that the draw command is working. You will want to add more of your own
     * tests!
     */
    @Test
    ...
    /**
     * Some simple tests that the fill command is working. You will want to add more of your own
     * tests!
     */
    @Test
    ...
    /**
     * Some simple tests that shape intersection is working. You will want to add more of your own
     * tests!
     */
    @Test
    ...
    /**
     * Some simple tests that shape union is working. You will want to add more of your own tests!
     */
    @Test
        ...
        for (int i = 0; i != inputs.length; ++i) {
            ...
            try {
                ...
                if (!input[1].equals(output)) {
                    System.out.println("Incorrect output on input " + i + " : " + input[0]
                            + "\nExpected output:\n" + input[1] + "\nReceived output:\n"
                            + canvas.toString() + "\n\n");
                    Assert.fail("Incorrect output on input " + i + " : " + input[0]
                            + "\nExpected output:\n" + input[1] + "\nReceived output:\n"
                            + canvas.toString() + "\n\n");
                }
            } catch (Exception e) {
                e.printStackTrace();
                Assert.fail("Exception occurred: " + e.getMessage() + " on input: " + input[0]);
            }
        }
    }
}
