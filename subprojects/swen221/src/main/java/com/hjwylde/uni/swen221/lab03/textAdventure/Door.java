...
/**
 * This class represents a door in the game. It provides references to the rooms which are on either
 * side of the door.
 * 
 * @author djp
 * 
...
public class Door implements Item {
    ...
    public String shortDescription() {
        return name + ".  It connects " + oneSide.getName() + " to " + otherSide.getName();
    }
