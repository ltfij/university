...
public class Board {
    ...
    /**
     * Apply a given move to this board, returning true is successful, otherwise false.
     */
    public boolean apply(Move move) {
        if (move.isValid(this)) { // If the move is valid...
            ...
            for (int col = 1; col <= 8; col++)
                if ((pieces[1][col] instanceof Pawn) || (pieces[8][col] instanceof Pawn)) {
    ...
    /**
     * The following method checks whether the given column is completely clear, except for a given
     * set of pieces. Observe that this doesn't guarantee a given column move is valid, since this
     * method does not ensure anything about the relative positions of the given pieces.
     * 
     ...
     */
    public boolean clearColumnExcept(Position startPosition, Position endPosition,
            Piece... exceptions) {
    ...
    /**
     * The following method checks whether the given diaganol is completely clear, except for a
     * given set of pieces. Observe that this doesn't guarantee a given diaganol move is valid,
     * since this method does not ensure anything about the relative positions of the given pieces.
     * 
     ...
     */
    public boolean clearDiaganolExcept(Position startPosition, Position endPosition,
            Piece... exceptions) {
    ...
    /**
     * The following method checks whether the given row is completely clear, except for a given set
     * of pieces. Observe that this doesn't guarantee a given row move is valid, since this method
     * does not ensure anything about the relative positions of the given pieces.
     * 
     ...
     * 
     * @param isWhite --- true means check whether white is in check; otherwise, check black.
     */
     ...
     * opposing piece is threatening that square. This is useful for checking whether a King can
     * castle through a given square and for checking if a King is in check or not.
     * 
