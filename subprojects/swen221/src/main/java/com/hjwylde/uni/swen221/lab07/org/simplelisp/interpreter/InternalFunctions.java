...
public class InternalFunctions {
    ...
    static public void setup_internals(final Interpreter interpreter) {
        ...
        interpreter.setGlobalExpr("print", new LispFunction(1) {
            ...
            @Override
            public LispExpr internal_invoke(LispExpr[] es, HashMap<String, LispExpr> locals,
        ...
        interpreter.setGlobalExpr("defun", new LispFunction(3, 0) {
            ...
            public LispExpr internal_invoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter.type_check("defun", es, LispSymbol.class, LispList.class,
                        LispList.class);
        ...
        interpreter.setGlobalExpr("subseq", new LispFunction(3) {
            ...
            public LispExpr internal_invoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter.type_check("subseq", es, LispSequence.class, LispInteger.class,
                        LispInteger.class);
