...
public interface Shape {
    ...
    /**
     * Check if this shape has collided with one of the outer walls. If so, respond in some
     * appropriate manner.
     */
    public void checkWallCollision(int width, int height);

    /**
     * A clock event is signaled. The shape must respond to this by moving in some manner.
     */
    public void clockTick();

    /**
     * Return the bounding box for the shape in question. The bounding box is useful as a first
     * stage in determining whether two shapes are touching.
     * 
