...
/**
 * Represents a move taken during a minesweeper game. Since every move has a position that it being
 * modified, it is contained here.
 * 
...
public abstract class Move {
    ...
    /**
     * Apply this move to the board, whilst checking that it is valid. If the move is invalid, then
     * a syntax error should be thrown.
     * 
