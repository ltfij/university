...
public class BooleanValueTests {
    ...
    public void testValidEquals() {
        Assert.assertTrue(new BooleanValue(true).equals(new BooleanValue(true)));
        Assert.assertTrue(new BooleanValue(false).equals(new BooleanValue(false)));
        Assert.assertTrue(!(new BooleanValue(false).equals(new BooleanValue(true))));
