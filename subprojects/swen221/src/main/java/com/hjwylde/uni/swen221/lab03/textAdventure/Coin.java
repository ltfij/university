...
public class Coin implements Item {
    ...
    public void pickUp(Player p, Room r) {
        System.out.println("You picked up " + amount
            + " gold coins.  You're rich!");
    ...
    public void prod(Player player, Room room) {
        System.out
            .println("You prodded the gold pieces.  You guessed it.  Nothing happened!");
    }
    ...
    public Room walkInto(Player player, Room room) {
        System.out
            .println("Don't be silly ... you can't walk into gold coins!");
        return room;
    }
}
