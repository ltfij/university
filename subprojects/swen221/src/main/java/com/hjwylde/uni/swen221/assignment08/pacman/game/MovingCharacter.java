...
/**
 * The moving character class represents characters on the pacman board which move. Moving
 * characters have a direction of movement, and a speed at which they are moving.
 * 
 * @author djp
 */
public abstract class MovingCharacter extends Character {
    ...
    public void tick(Board game) {
        // The following are used to determine the point at which a character can change direction
        // (if a
        // change is queued).
