...
public class Main {
    ...
    public static String[] corrects = {
        "Nice one!", "Yeah, you got it!", "Yup!", "Sure thing!", "Oh yeah!",
        "Sweet as!", "No problem!", "Easy as!",
        "You're getting the hang of this!", "Way to go!", "You got it sorted!",
        "You're a winner!", "Yes"
    };
    
    public static String[] wrongs = {
        "Sorry", "Better luck next time", "Nope, that's not it", "Unlucky",
        "Close, but not close enough!", "That 'aint right",
        "Sorry, good effort though",
        "Nope. It's participation that counts, right?",
        "No.  Remember, there are no points for second place!",
        "Oh well, you'll get it next time!", "No",
        "Nope --- it's trickier than it looks!"
    };
