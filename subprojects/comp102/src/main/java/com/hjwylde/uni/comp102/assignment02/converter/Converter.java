...
/*
 * Code for Assignment 2, COMP 102 Name: Henry J. Wylde Usercode: wyldehenr ID: 300224283
 */
...
public class Converter {
    ...
    private static JRadioButton kiloToMile = new JRadioButton(Converter.KILO_TO_MILE);
    private static JRadioButton mileToKilo = new JRadioButton(Converter.MILE_TO_KILO);
    ...
    private static void setUpGUI() {
        ...
        Converter.convertUnit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                final String command = buttonGroup.getSelection().getActionCommand();
                double distanceValue = 0;

                if (command.equals(Converter.KILO_TO_MILE))
                    distanceValue =
                            Double.parseDouble(Converter.inputBox.getText())
                ...
                Converter.convertedUnit.setText(String.valueOf(Converter.Round(distanceValue, 3)));
