...
/**
 * Dot represents a small circle shape of a fixed size (5 pixels) Implements the Shape interface.
 */
public class Dot implements Shape {
    ...
    /**
     * Creates a new Dot class taking the parameters for it's position on a 2d plane and color.
     * 
    ...
    /**
     * Creates a new Dot class taking a scanner holding values for the parameters for it's position
     * on a 2d plane and color values.
     * 
     * @param data the scanner.
     */
    public Dot(Scanner data) {
        this(data.nextInt(), data.nextInt(), new Color(data.nextInt(), data.nextInt(),
                data.nextInt()));
    }
    ...
    /**
     * Required by interface. A Dot must have a fixed width and height of 5 pixels.
     */
    @Override
     ...
     * 
     * @param p the position to set to.
     */
    ...
    public String toString() {
        return ("Dot " + p.x + " " + p.y + " " + color.getRed() + " " + color.getGreen() + " " + color
                .getBlue());
    }
}
