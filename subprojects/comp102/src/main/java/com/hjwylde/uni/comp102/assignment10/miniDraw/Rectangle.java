...
public class Rectangle implements Shape {
    ...
    /**
     * Creates a new Rectangle class taking the parameters for the top left corner, width and height
     * on a 2d plane and color.
     * 
    ...
    /**
     * Creates a new Rectangle class taking a scanner holding values for the parameters for it's the
     * top left corner, width and height on a 2d plane and color values.
     * 
    ...
    public String toString() {
        return ("Rect " + p.x + " " + p.y + " " + width + " " + height + " " + color.getRed() + " "
