...
public class Oval implements Shape {
    ...
    /**
     * Creates a new Oval class taking the parameters for the top left corner, width and height on a
     * 2d plane and color.
     * 
    ...
    /**
     * Creates a new Oval class taking a scanner holding values for the parameters for it's the top
     * left corner, width and height on a 2d plane and color values.
     * 
    ...
    public boolean pointOnShape(int x, int y) {
        ...
        // within the ellipse.
        double result = (Math.pow(x - p.x, 2) / aSquared) + (Math.pow(y - p.y, 2) / bSquared);
    ...
    public String toString() {
        return ("Oval " + (p.x - a) + " " + (p.y - b) + " " + (a * 2) + " " + " " + (b * 2) + " "
