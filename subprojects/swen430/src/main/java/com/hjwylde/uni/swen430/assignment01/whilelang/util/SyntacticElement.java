...
/**
 * A Syntactic Element represents any part of the file for which is relevant to the syntactic
 * structure of the file, and in particular parts we may wish to add information too (e.g. line
 * numbers, types, etc).
 *
 * @author David Pearce
 */
