...
public class InternalFunctions {
    ...
    public static void setupInternalFunctions(final Interpreter interpreter) {
        ...
        interpreter.setGlobalExpr("%", new LispFunction(2) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                    HashMap<String, LispExpr> globals) {
                interpreter.typeCheck("%", es, LispInteger.class, LispInteger.class);
        ...
        interpreter.setGlobalExpr("defun", new LispFunction(3, 0) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter
                        .typeCheck("defun", es, LispSymbol.class, LispList.class, LispList.class);
        ...
        interpreter.setGlobalExpr("lambda", new LispFunction(2, 0) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                    HashMap<String, LispExpr> globals) {
                interpreter.typeCheck("lambda", es, LispList.class, LispExpr.class);
        ...
        interpreter.setGlobalExpr("set", new LispFunction(2, 0) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter.typeCheck("set", es, LispSymbol.class, Object.class);
        ...
        interpreter.setGlobalExpr("setq", new LispFunction(2, 0) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter.typeCheck("setq", es, LispSymbol.class, Object.class);
        ...
        interpreter.setGlobalExpr("let", new LispFunction(2, 0) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter.typeCheck("let", es, LispList.class, LispExpr.class);
        ...
        interpreter.setGlobalExpr("subseq", new LispFunction(3) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter.typeCheck("subseq", es, LispSequence.class, LispInteger.class,
                        LispInteger.class);
        ...
        interpreter.setGlobalExpr("elt", new LispFunction(2) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter.typeCheck("elt", es, LispSequence.class, LispInteger.class);
        ...
        interpreter.setGlobalExpr("car", new LispFunction(1) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                if (l.size() < 1)
                    throw new Error("cannot take head of empty list in \"car\"!");
                return l.get(0);
            }
        });
        ...
        interpreter.setGlobalExpr("cons", new LispFunction(2, 2) {
            ...
            public LispExpr internalInvoke(LispExpr[] es, HashMap<String, LispExpr> locals,
                ...
                interpreter.typeCheck("cons", es, LispExpr.class, LispExpr.class);
                LispExpr head = es[0];
                LispList r = new LispList();
