 ...
 * @since 31/08/2013
 */
public final class BoardFrame extends JFrame implements ActionListener, WindowListener {
    ...
    private final JMenuItem miViewKeeperCards = new JMenuItem("View Keeper Cards", 'k');
    ...
    public BoardFrame(Board board) {
        ...
        wrapper.setBorder(BorderFactory.createLineBorder(new Color(0, 42, 96), 10));
        wrapper.add(canvas);
        content.add(wrapper);
    ...
    public Optional<PlayerTurnChoice> getTurnRequest() {
        Optional<PlayerTurnChoice> ret =
                Optional.fromNullable(turnRequest).or(
    ...
    private void initialiseMenu() {
        ...
        miViewKeeperCards.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_K,
                java.awt.Event.CTRL_MASK));
        miViewNotebook.addActionListener(this);
        miViewNotebook.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N,
                java.awt.Event.CTRL_MASK));
        miEndTurn.addActionListener(this);
        miEndTurn.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E,
                java.awt.Event.CTRL_MASK));
