...
public final class Main {
    ...
    private static final String DEFAULT_BOARD_PATH = "res/board.txt";
    ...
    private static Tile[][] loadBoard() {
        ...
        try {
            tiles = Tiles.parseTiles(Paths.get(DEFAULT_BOARD_PATH));
            
            return tiles;
        } catch (IOException e) {
            // Use System.out not System.err so all print messages are queued correctly
            System.out.println("Unable to load board from: "
                + DEFAULT_BOARD_PATH);
