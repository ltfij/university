...
public class SortedArrayBag<E> extends AbstractCollection<E> {
    ...
    /**
     * Constructs SortedArrayBag out of the given collection that will use the
    ...
    /**
     * Adds the specified element to this bag Returns true if the collection
    ...
    /**
     * Returns true iff the bag contains an item. Uses findIndex to find the
    ...
    /**
     * Remove the element matching a given item Returns true if the collection
     * changes, and false if
     * it did not change.
     */
    @Override
    ...
    /**
     * Sorts the data array, from 0 to count, using the comparator in the comp
     * field. Note that this
     * is not a good design - this code is private to this class, and can't be
     * reused. It would be
     * much nicer to make more re-usable code, for example by having a separate
     * Sorting class. (Even
