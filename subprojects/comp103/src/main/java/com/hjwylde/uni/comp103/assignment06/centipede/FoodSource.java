...
/**
 * A Food Source is a (never ending) food source stuck on the ground. It comes in six types, some
 * make centipedes grow, the rest don't. It can draw itself, and return its position and type. It
 * takes 20 ticks to regrow after it has been eaten. This is represented by its age, and mature() is
...
public class FoodSource {
    ...
    public enum Food {
        Nutritious, Poison, Wasting, Divisive, BadTaste, Spicy
    }
