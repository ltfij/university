...
public class SortedArrayBag<E> extends AbstractCollection<E> {
    ...
    /**
     * Construct a SortedArrayBag out of the given collection that will use the default comparator.
    ...
    /**
     * Construct SortedArrayBag out of the given collection that will use the given comparator. It
    ...
    /**
     * Return true iff the bag contains an item. Uses findIndex to find the position the item should
     * be if it is present
     */
    ...
    /**
     * Sort the data array, from 0 to count, using the comparator in the comp field.
     */
