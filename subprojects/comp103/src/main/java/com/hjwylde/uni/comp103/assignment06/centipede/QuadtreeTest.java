...
/*
 * Code for Assignment 6, COMP 103 Name: Henry J. Wylde Usercode: wyldehenr ID: 300224283 I have
 * included this class which is a test class to see how the Quadtree works. You may click the mouse
 * anywhere on the screen, which it will insert an index into the Quadtree, and then draw the
 ...
 * within this area (outputed with System.out.println(...)). The drawing abilities aren't the best,
 * but they do show the Quadtree structure correctly.
 */
...
public class QuadtreeTest extends JFrame implements MouseListener, MouseMotionListener {
    ...
    public void drawFrame() {
        ...
        try {
            ...
            if ((beginDragX != -1) && (beginDragY != -1)) {
                ...
                Rectangle selected = getBounds(beginDragX, beginDragY, endDragX, endDragY);
    ...
    public void mouseClicked(MouseEvent e) {
        System.out.println("Adding in index " + counter + " of size " + tileSize + "x" + tileSize
                + " at: (" + e.getX() + ", " + e.getY() + ")");
        tree.insert(counter++, new Rectangle(e.getX(), e.getY(), tileSize, tileSize));
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        Rectangle toSearch = getBounds(beginDragX, beginDragY, e.getX(), e.getY());
