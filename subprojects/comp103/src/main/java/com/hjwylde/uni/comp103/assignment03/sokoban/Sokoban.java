...
public class Sokoban implements ActionListener, KeyListener, MouseListener {
    ...
    /**
     * Move the agent in the specified direction, if possible. If there is box in front of the agent
     * and a space in front of the box, then push the box. Otherwise, if there is anything in front
     * of the agent, do nothing.
     */
    ...
    /**
     * Returns true iff the warehouse is solved - all the shelves have boxes on them
     */
    ...
    /**
     * Pull: (useful for undoing a push in direction d) move the agent in the reverse direction from
    ...
    /**
     * Retreat: (useful for undoing a move in direction d) move the agent in the reverse direction
     * from d.
     */
    ...
    private void drawAgent() {
        canvas.drawImage(agentMapping.get(agentDirection), Sokoban.leftMargin
                ...
                + (Sokoban.cellSize * agentPos.row), Sokoban.cellSize, Sokoban.cellSize, false);
    }
    ...
    private void drawCell(int row, int col) {
        ...
        if (imageName != null)
            canvas.drawImage(imageName, Sokoban.leftMargin + (Sokoban.cellSize * col),
                    Sokoban.topMargin + (Sokoban.cellSize * row), Sokoban.cellSize,
     ...
     * 
     * @param tried An array holding a boolean value as to whether that cell on the map has been
     *        tried before.
     * @param start Start position.
     * @param end End position to get to.
     */
    private void findPath(boolean[][] tried, Coord start, Coord end) throws Exception {
