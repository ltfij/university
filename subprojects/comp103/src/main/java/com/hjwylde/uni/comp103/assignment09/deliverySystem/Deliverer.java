...
public class Deliverer {
    ...
    public double getReturnTime() {
        if (pkg == null)
            return leftTime
                    + (deliveredPackages.get(deliveredPackages.size() - 1).getDeliveryTime() * 2);
    ...
    /**
     * Validates a package in terms of the deliverer. A package is a valid package if the deliverer
