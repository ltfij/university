package com.hjwylde.uni.swen221.assignment2.tests;
        ...
        try {
            ...
            for (int i = 0; i != walkerPath.length; ++i)
                if ((i >= walkerPath.length) || (i >= correctPath.length)
                    ...
                    Assert.fail("walker path is: "
                        + LeftWalkerTests.pathString(walkerPath)
                        + ", correct path is: "
                        + LeftWalkerTests.pathString(correctPath));
