...
@RunWith(Suite.class)
@Suite.SuiteClasses({
    MyTableTests.class, MyRowTests.class, MyRowListTests.class
})
public class TableTestSuite {
    ...
    public static final Object[][] RAW_TABLE_ROWS = {
        {
            0, "Hello WOrld"
        }, {
            1, "Blah"
    ...
    public static final Object[][] RAW_TABLE3_ROWS = {
        {
            0, "Hello WOrld", true
        }, {
            1, "Blah", false
    ...
    public static final Object[][] RAW_REF_ROWS = {
        {
    ...
    public static final Object[][] RAW_REF_INVALID_ROWS = {
        {
            0, "Not a reference value"
        }
    };
    ...
    public static MyDatabase generateDb() {
        ...
        db.table("table").rows()
            .add(Arrays.asList(TableTestSuite.TABLE_ROWS[1]));
        ...
        db.table("table3").rows()
            .add(Arrays.asList(TableTestSuite.TABLE3_ROWS[0]));
        db.table("table3").rows()
            .add(Arrays.asList(TableTestSuite.TABLE3_ROWS[1]));
        db.table("table3").rows()
            .add(Arrays.asList(TableTestSuite.TABLE3_ROWS[2]));
