...
public final class Pacman extends MovingCharacter {
    ...
    public static final Image[] PACMAN_RIGHT = {
        BoardCanvas.loadImage("pacman2.png"),
        BoardCanvas.loadImage("pacman2.png"),
        BoardCanvas.loadImage("pacman3.png"),
        BoardCanvas.loadImage("pacman3.png"),
        BoardCanvas.loadImage("pacman4.png"),
        BoardCanvas.loadImage("pacman4.png"),
        BoardCanvas.loadImage("pacman3.png"),
        BoardCanvas.loadImage("pacman3.png")
    };
    
    private static final Image[] PACMAN_LEFT = {
        BoardCanvas.rotate(Pacman.PACMAN_RIGHT[0], 180),
    ...
    private static final Image[] PACMAN_UP = {
        BoardCanvas.rotate(Pacman.PACMAN_RIGHT[0], -90),
    ...
    private static final Image[] PACMAN_DOWN = {
        BoardCanvas.rotate(Pacman.PACMAN_RIGHT[0], 90),
        BoardCanvas.rotate(Pacman.PACMAN_RIGHT[1], 90),
        BoardCanvas.rotate(Pacman.PACMAN_RIGHT[2], 90),
        BoardCanvas.rotate(Pacman.PACMAN_RIGHT[3], 90),
    ...
    private static final Image[] PACMAN_DYING = {
        BoardCanvas.loadImage("pacman1.png"),
        BoardCanvas.loadImage("pacman2.png"),
        BoardCanvas.loadImage("pacman3.png"),
        BoardCanvas.loadImage("pacman4.png"),
        BoardCanvas.loadImage("pacman5.png"),
        BoardCanvas.loadImage("pacman6.png"),
        BoardCanvas.loadImage("pacman7.png"),
    };
    
    public static final Image[] PACMAN2_RIGHT = {
        BoardCanvas.loadImage("pacman22.png"),
        BoardCanvas.loadImage("pacman22.png"),
        BoardCanvas.loadImage("pacman23.png"),
        BoardCanvas.loadImage("pacman23.png"),
        BoardCanvas.loadImage("pacman24.png"),
        BoardCanvas.loadImage("pacman24.png"),
        BoardCanvas.loadImage("pacman23.png"),
        BoardCanvas.loadImage("pacman23.png")
    };
    
    private static final Image[] PACMAN2_LEFT = {
        BoardCanvas.rotate(Pacman.PACMAN2_RIGHT[0], 180),
    ...
    private static final Image[] PACMAN2_UP = {
        BoardCanvas.rotate(Pacman.PACMAN2_RIGHT[0], -90),
    ...
    private static final Image[] PACMAN2_DOWN = {
        BoardCanvas.rotate(Pacman.PACMAN2_RIGHT[0], 90),
        BoardCanvas.rotate(Pacman.PACMAN2_RIGHT[1], 90),
        BoardCanvas.rotate(Pacman.PACMAN2_RIGHT[2], 90),
        BoardCanvas.rotate(Pacman.PACMAN2_RIGHT[3], 90),
    ...
    private static final Image[] PACMAN2_DYING = {
        BoardCanvas.loadImage("pacman21.png"),
        BoardCanvas.loadImage("pacman22.png"),
        BoardCanvas.loadImage("pacman23.png"),
        BoardCanvas.loadImage("pacman24.png"),
        BoardCanvas.loadImage("pacman25.png"),
        BoardCanvas.loadImage("pacman26.png"),
        BoardCanvas.loadImage("pacman27.png"),
    };
    ...
    public void draw(Graphics g) {
        if (state == 0)
            ...
            case MovingCharacter.UP:
                g.drawImage(Pacman.PACMAN2_UP[Math.abs(realY % 30) / 4], realX,
                    realY, null, null);
                break;
            case MovingCharacter.DOWN:
                g.drawImage(Pacman.PACMAN2_DOWN[Math.abs(realY % 30) / 4],
                    realX, realY, null, null);
                break;
            case MovingCharacter.RIGHT:
                g.drawImage(Pacman.PACMAN2_RIGHT[Math.abs(realX % 30) / 4],
                    realX, realY, null, null);
                break;
            case MovingCharacter.LEFT:
                g.drawImage(Pacman.PACMAN2_LEFT[Math.abs(realX % 30) / 4],
                    realX, realY, null, null);
                break;
            default:
                // stopped
            ...
            g.drawImage(Pacman.PACMAN2_DYING[(state - 1) / 3], realX, realY,
                null, null);
    }
    ...
    public void drawOwn(Graphics g) {
        if (state == 0)
            switch (direction) {
            case MovingCharacter.UP:
                g.drawImage(Pacman.PACMAN_UP[Math.abs(realY % 30) / 4], realX,
                    realY, null, null);
                break;
            case MovingCharacter.DOWN:
                g.drawImage(Pacman.PACMAN_DOWN[Math.abs(realY % 30) / 4],
                    realX, realY, null, null);
                break;
            case MovingCharacter.RIGHT:
                g.drawImage(Pacman.PACMAN_RIGHT[Math.abs(realX % 30) / 4],
                    realX, realY, null, null);
                break;
            case MovingCharacter.LEFT:
                g.drawImage(Pacman.PACMAN_LEFT[Math.abs(realX % 30) / 4],
                    realX, realY, null, null);
                break;
            default:
                // stopped
            ...
            g.drawImage(Pacman.PACMAN_DYING[(state - 1) / 3], realX, realY,
                null, null);
    }
     ...
     */
    public static Pacman fromInputStream(int rx, int ry, DataInputStream din)
        throws IOException {
