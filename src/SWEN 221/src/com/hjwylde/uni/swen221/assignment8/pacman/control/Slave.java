...
/**
 * A slave connection receives information about the current state of the board and relays that into
 * the local copy of the board. The slave connection also notifies the master connection of key
