    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd.equals("Reset"))
            ...
            shapes.add(new Square(randomWidth(), randomPosition(),
                randomVelocity(), Color.BLUE));
        else if (cmd.equals("Add Rectangle"))
            shapes.add(new Rectangle(randomPosition(), randomWidth(),
                randomWidth(), randomVelocity(), Color.RED));
        else if (cmd.equals("Add Circle"))
            shapes.add(new Circle(randomPosition(), randomWidth(),
                randomVelocity(), Color.DARK_GRAY));
            ...
            shapes.add(new Polytope(randomPosition(), points, randomVelocity(),
                Color.MAGENTA));
        }
    }
