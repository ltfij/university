package com.hjwylde.uni.swen221.assignment3.chessview;
...
import com.hjwylde.uni.swen221.assignment3.chessview.moves.*;
import com.hjwylde.uni.swen221.assignment3.chessview.pieces.*;
...
public class ChessGame {
    ...
    public ChessGame(Reader input) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            /*
             * Checks: whether the move is that of a king, rook or castle.
             * If it is a rook or king, it will change the correct flags to show that white can no
             * longer
             * castle on 1 side or both.
             * If it is a castle move, it will check what type of castle it is and set whether it is
             * valid
             * based on the flags.
             */
            ...
            if (rounds.size() > 0)
                ChessGame
                    .validateEnPassant(unwrappedWhite, ChessGame
                        .unwrapMove(rounds.get(rounds.size() - 1).black()));
            
            Move black = null;
            if (pos != line.length()) {
                black = ChessGame
                    .moveFromString(line.substring(pos + 1), false);
                
                /*
                 * Checks: whether the move is that of a king, rook or castle.
                 * If it is a rook or king, it will change the correct flags to show that black can
                 * no
                 * longer
                 * castle on 1 side or both.
                 * If it is a castle move, it will check what type of castle it is and set whether
                 * it is
                 * valid
                 * based on the flags.
                 */
    ...
    private static Move moveFromString(String str, boolean isWhite) {
        ...
        Position start = ChessGame.positionFromString(str.substring(index,
            index + 2));
        ...
        Position end = ChessGame.positionFromString(str.substring(index,
            index + 2));
        index = index + 2;
