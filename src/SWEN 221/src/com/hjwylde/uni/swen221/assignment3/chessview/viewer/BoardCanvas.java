package com.hjwylde.uni.swen221.assignment3.chessview.viewer;
...
public class BoardCanvas extends Canvas {
    ...
    public void paint(Graphics g) {
        ...
        BoardCanvas.drawBackground(g, width + 2, 2, width, height);
    ...
    private void drawPieces(Graphics g, int startx, int starty, int width,
        ...
        for (int row = 1; row <= 8; ++row) {
            ...
            for (int col = 1; col <= 8; ++col) {
                ...
                if (p != null)
                    BoardCanvas.drawPiece(p, g, xpos, ypos, width, height);
            }
        }
    }
