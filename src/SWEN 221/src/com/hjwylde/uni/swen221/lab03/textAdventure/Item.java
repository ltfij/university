...
public interface Item {
    ...
    /**
     * Try to walk into this item (if it's a door, you'll go through it!). This
     * method should return the room the player is now in. If no room change has
     * taken place, then it just returns the room parameter given.
     */
