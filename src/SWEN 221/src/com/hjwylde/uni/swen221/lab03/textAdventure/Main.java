...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Door loungeDinningDoor = new LockedDoor("South Exit", lounge,
            dinningRoom, loungeDiningKey);
        ...
        hallway.getItems().add(
            new Book("I'm a title!", "I'm a blurb!", "Woooo a clue!"));
        lounge.getItems().add(
            new HeavyItem("A very heavy item.",
                "Nope, my bad. It's extremely heavy."));
    ...
    public static void playGame(Player player, Room room, Scanner scanner) {
        ...
        while (!finished) {
            System.out.println("================================");
            System.out.println(player.getName() + ", you are in "
                + room.getName() + ".  You see:\n");
            ...
            if (room.getItems().isEmpty())
                ...
                System.out.println("\nYou can see the following things in "
                    + room.getName() + ":");
                int idx = 0;
            ...
            while (room == oldRoom) {
                ...
                if (action.equals("E") || action.equals("W")
                    || action.equals("N") || action.equals("S")) {
                    room = Main.walkInto(player, room, action);
                    Main.pause();
                } else if (action.equals("P")) {
                    System.out.println("Pick up which item?");
                    int item = Main.inputNumber(1, room.getItems().size(),
                        scanner);
                    ...
                    System.out
                        .println("You dropped " + item.shortDescription());
                    Main.pause();
                    ...
                    int item = Main.inputNumber(1, room.getItems().size(),
                        scanner);
                    System.out.println(room.getItems().get(item - 1)
                        .longDescription());
                    Main.pause();
