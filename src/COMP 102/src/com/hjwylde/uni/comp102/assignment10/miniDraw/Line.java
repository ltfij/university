...
public class Line implements Shape {
    ...
    /**
     * Creates a new Line class taking the parameters for two points on a 2d plane
     * and color values.
     * 
     * @param x1
     *            the x1 co-ordinate.
    ...
    /**
     * Creates a new Line class taking a scanner holding values for the parameters
     * for it's two points on a 2d plane and color values.
     * 
     * @param data
     *            the scanner.
     */
    ...
    public boolean pointOnShape(int x, int y) {
        int threshold = 3;
        if ((x < (Math.min(p1.x, p2.x) - threshold))
            || (x > (Math.max(p1.x, p2.x) + threshold))
