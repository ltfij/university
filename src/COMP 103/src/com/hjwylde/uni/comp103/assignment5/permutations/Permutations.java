package com.hjwylde.uni.comp103.assignment5.permutations;
...
/**
 * Prints out all permuations of a string The static method permute constructs
...
public class Permutations {
    ...
    public static void main(String[] arguments) {
        ...
        System.out.println("Number of permutations of " + string + " is "
            + permutations.size());
