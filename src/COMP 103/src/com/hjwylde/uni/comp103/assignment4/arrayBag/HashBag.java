...
public class HashBag<E> extends AbstractCollection<E> {
    ...
    /**
     * Adds the specified element to this bag if it is not already present. Will
     * not add the null
     * value. Returns true if the collection changes, and false if it did not
     * change.
     */
    @Override
    ...
    /**
     * Returns an iterator over the elements in this bag. Uses the hashMap
    ...
    /**
     * Remove an element matching a given item Makes no change to the bag and
    ...
    private class HashBagIterator<E> implements Iterator<E> {
        ...
        private HashBagIterator(HashBag<E> bag,
            Iterator<Map.Entry<E, Counter>> it) {
            this.bag = bag;
            iter = it;
            getNextReady();
        }
        ...
        /**
         * Gets the next item out of the entrySet iterator, ready for the next call
         * to next.
         */
