...
public class LanderCanvas extends JPanel implements KeyListener {
    ...
    private static final int[] GROUND_XS = {
        0, 30, 40, 100, 140, 160, 180, 200, 220, 230, 300, 310, 330, 350, 360,
        400, 410, 435, 460, 465, 500, 545, 560, 575, 580, 600, 600, 0
    };
    private static final int[] GROUND_YS = {
        500, 450, 480, 510, 350, 400, 395, 480, 490, 480, 480, 520, 515, 520,
        515, 550, 400, 350, 360, 400, 410, 480, 455, 465, 480, 500, 600, 600
    };
    private static final int[] LANDER_XS = {
        11, 13, 27, 29, 30, 26, 37, 40, 40, 30, 30, 33, 24, 21, 24, 16, 19, 16,
        7, 0, 0, 10, 10, 3, 14, 10
    };
    private static final int[] LANDER_YS = {
        5, 0, 0, 5, 20, 20, 35, 35, 40, 40, 35, 35, 20, 20, 25, 25, 20, 20, 35,
        35, 40, 40, 35, 35, 20, 20
    };
    private static final Polygon TERRAIN = new Polygon(GROUND_XS, GROUND_YS,
        GROUND_XS.length);
    ...
    public void paint(Graphics g) {
        ...
        g.fillPolygon(getAdjustedLanderXs(), getAdjustedLanderYs(),
            LANDER_XS.length);
        
        g.setColor(Color.RED);
        g.fillRect(500, 20, fuel / 25, 10);
        
        Rectangle box = new Polygon(getAdjustedLanderXs(),
            getAdjustedLanderYs(), LANDER_XS.length).getBounds();
        if (upPressed) {
            Polygon thruster = new Polygon(new int[] {
                (int) box.getMinX(), (int) (box.getMinX() + 10),
                (int) (box.getMinX() + 5)
            }, new int[] {
                (int) box.getMaxY(), (int) box.getMaxY(),
                (int) (box.getMaxY() + 8)
            }, 3);
            g.fillPolygon(thruster);
            thruster = new Polygon(new int[] {
                (int) box.getMaxX() - 10, (int) (box.getMaxX()),
                (int) (box.getMaxX() - 5)
            }, new int[] {
                (int) box.getMaxY(), (int) box.getMaxY(),
                (int) (box.getMaxY() + 8)
        ...
        if (rightPressed) {
            Polygon thruster = new Polygon(new int[] {
                (int) box.getMaxX(), (int) (box.getMaxX()),
                (int) (box.getMaxX() + 8)
            }, new int[] {
                (int) box.getMaxY(), (int) box.getMaxY() - 7,
                (int) (box.getMaxY() - 3)
            }, 3);
            g.fillPolygon(thruster);
        }
        if (leftPressed) {
            Polygon thruster = new Polygon(new int[] {
                (int) box.getMinX(), (int) (box.getMinX()),
                (int) (box.getMinX() - 8)
            }, new int[] {
                (int) box.getMaxY(), (int) box.getMaxY() - 7,
                (int) (box.getMaxY() - 3)
