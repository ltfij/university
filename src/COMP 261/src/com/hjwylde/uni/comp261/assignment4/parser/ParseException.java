...
/**
 * An exception that is thrown if a file can not be parsed using a certain grammar. Has an optional
 * error message parameter to give details about the <code>ParseException</code>.
 * 
