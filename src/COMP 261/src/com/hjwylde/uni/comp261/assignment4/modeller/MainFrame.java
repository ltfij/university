package com.hjwylde.uni.comp261.assignment4.modeller;
...
import com.hjwylde.uni.comp261.assignment4.graphics.World2d;
import com.hjwylde.uni.comp261.assignment4.graphics.World3d;
import com.hjwylde.uni.comp261.assignment4.parser.ParseException;
...
public class MainFrame extends JFrame {
     ...
     */
    public static final javax.swing.filechooser.FileFilter POLY_FILTER = new javax.swing.filechooser.FileFilter() {
    ...
    private JCheckBoxMenuItem miWireframeMode, miHiddenRemovalMode,
        miRenderLightsMode;
    ...
    private void initMenuBar() {
        ...
        miCameraAngle.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    world.setViewAngle((Main.constrain(
                        Double.parseDouble(input), 0.0, 180.0) * Math.PI) / 180.0); // Constrain
                                                                                    // angle and
                                                                                    // convert to
                                                                                    // radians.
        ...
        miAmbientLight.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    World3d.ambientLight = Main.constrain(
                        Double.parseDouble(input), 0.0, 1.0); // Constrain ambient light.
                } catch (NumberFormatException e2) {
                    return; // User entered something that isn't a number!
                }
            }
         ...
         * see if
         * wireframe mode is not selected as z-buffering will remove hidden surfaces for most of the
         * time.
         */
