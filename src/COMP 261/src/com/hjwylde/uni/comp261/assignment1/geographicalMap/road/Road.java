package com.hjwylde.uni.comp261.assignment1.geographicalMap.road;
...
public class Road {
    ...
    public static final double[] SPEED_ZONES = {
        5.0, 20.0, 40.0, 60.0, 80.0, 100.0, 110.0, 0.0
    };
    ...
    public String toString() {
        return "Road [rID=" + rID + ", label=" + label + ", city=" + city
            + ", speedZone=" + speedZone + ", roadClass=" + roadClass
            + ", oneWay=" + oneWay + ", useableByCar=" + useableByCar
            + ", useableByPedestrian=" + useableByPedestrian
