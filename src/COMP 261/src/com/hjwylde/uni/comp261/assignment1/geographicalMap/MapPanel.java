...
public class MapPanel extends JPanel implements MouseListener {
    ...
    public static final javax.swing.filechooser.FileFilter TAB_FILTER = new javax.swing.filechooser.FileFilter() {
    ...
    public void generateMapImage() {
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                mapImage = aucklandMap.generateMapImage(mapSize, drawNodes,
                    drawRoads, (drawPath ? shortestPath : null));
    ...
    public void loadNodes() {
        ...
        if (!tabFile.exists()) {
            JOptionPane.showMessageDialog(this, "Could not load nodes from: \""
    ...
    public void loadRoadRestrictions() {
        ...
        if (!tabFile.exists()) {
            JOptionPane.showMessageDialog(
                this,
                "Could not load road restrictions from: \""
                    + tabFile.toString() + "\"\nPlease pick the correct path.",
        ...
        if (!aucklandMap.loadRoadRestrictions(tabFile))
            JOptionPane
                .showMessageDialog(
                    ...
                    "Error loading road restrictions",
    ...
    public void loadRoads() {
        ...
        if (!tabFile.exists()) {
            JOptionPane.showMessageDialog(this, "Could not load roads from: \""
                + tabFile.toString() + "\"\nPlease pick the correct path.",
    ...
    public void loadRoadSegments() {
        ...
        File tabFile = new File(Main.ROOT_PATH,
            "roadInfo/roadSeg-roadID-length-nodeID-nodeID.tab");
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        int xOffset = ((getWidth() > getHeight()) ? ((getWidth() - getHeight()) / 2)
            : 0);
        ...
        if ((mouseClickStart == null) || (mouseClickEnd != null)) {
            ...
            if (shortestPath == null)
                JOptionPane.showMessageDialog(this, "No path found between ("
                    + n1 + ") and (" + n2 + ").", "Map Searching",
                    JOptionPane.ERROR_MESSAGE);
            else
    ...
    public void paint(Graphics g) {
        ...
        if (mapImage != null) {
            ...
            iG.drawImage(mapImage, xOffset, 0, (int) getMinEdge(),
                (int) getMinEdge(), this);
            ...
            if (mouseClickStart != null) {
                click = aucklandMap
                    .scaleVectorTo(mouseClickStart, getMinEdge());
                click.setLocation(click.getX() + xOffset, click.getY());
                
                iG.fillOval((int) click.getX() - 3, (int) click.getY() - 3, 6,
                    6);
            }
            ...
            g.drawRect(
                (getWidth() - (fm.stringWidth("No map image to draw.") + 30)) / 2,
                getHeight() / 2, fm.stringWidth("No map image to draw.") + 30,
                fm.getHeight() + 20);
            
            g.drawString(
                "No map image to draw.",
