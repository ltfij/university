package com.hjwylde.uni.comp261.assignment5.system;
        ...
        try (BufferedReader br = new BufferedReader(
            ...
            while (br.ready()) {
                ...
                if ((eol != null) && !eol.equals("")) {
                    System.err
                        .println("ERROR: Expected the block to end with a new line!");
                    return false;
                }
                Block b = new Block();
                if (!b.set(data))
                    System.err
                        .println("ERROR: Internal error - block size should've matched!");
                blocks.add(b);
            }
        } catch (IOException e) {
