...
import com.hjwylde.uni.comp261.assignment3.robotSimulator.parser.types.InstructionType;
import com.hjwylde.uni.comp261.assignment3.robotSimulator.parser.types.OperationType;
...
public class InstructionNode implements Node {
    ...
    /**
     * Add an instruction to execute when the else condition is reached in
     * an if statement. Only useful if <code>type = InstructionType.IF</code>.
     * 
     ...
     */
    public void execute(Map<VariableNode, Integer> variables, int robotID,
        ...
        case MOVE:
            world
                .moveRobot(robotID, val.evaluate(variables, robotID, world), g);
            
            break;
        case TURN:
            world
                .turnRobot(robotID, val.evaluate(variables, robotID, world), g);
