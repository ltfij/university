...
/**
 * A helper class that iterates through a <code>CharSequence</code> with methods
 * such as <code>expect(CharSequence expect);</code> and <code>hasNext();</code> .
 * 
...
public class ParserScanner {
    ...
    /**
     * Expect the given <code>CharSequence</code>, clearing whitespace before and
     * after checking, advancing the index if it is found, throwing a <code>ParseException</code> if
     * the given <code>CharSequence</code> was not
     * found.
     * 
    ...
    /**
     * Expect the given <code>CharSequences</code> clearing whitespace before and
     * after checking each expect. Advances the index after each expect, throws a
     * <code>ParseException</code> if an expect was not found.
     * 
    ...
    /**
     * Expect the given <code>CharSequence</code>, clearing whitespace before and
     * after checking the expect if <code>clear</code>. Throws a <code>ParseException</code> if the
     * expect was not found.
     * 
     * @param expect the CharSequence to expect.
     * @param clear whether to clear whitespace before and after checking the
     *            expect.
     * @throws ParseException if the CharSequence was not found.
     */
    ...
    /**
     * Expect the given <code>CharSequence</code>, clearing whitespace before and
     * after checking the expect if <code>clearBefore</code> and <code>clearAfter</code>
     * respectively.
     * Throws a <code>ParseException</code> if the expect was not found.
     * 
     * @param expect the CharSequence to expect.
    ...
    /**
     * Expect at least one more token from this <code>ParserScanner</code>. This
     * method does not advance the iterator, it only throws a <code>ParseException</code> if there
     * are
     * no more tokens.
     * 
    ...
    /**
     * Check whether this <code>ParserScanner</code> has any more tokens to
     * iterate through.
     * 
     ...
     * or the next token is not an <code>int</code>.
     * 
     * @return the next int.
     */
    public int nextInt() {
