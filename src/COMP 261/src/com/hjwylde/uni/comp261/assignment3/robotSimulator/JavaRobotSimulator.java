...
public class JavaRobotSimulator {
    ...
    public static void main(String[] args) {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!world.validWorldLoaded()) {
                    JOptionPane.showMessageDialog(null,
                        "Cannot control robots, since no world is loaded!",
                ...
                String selectedRobot = (String) JOptionPane.showInputDialog(
                    null, "Select which robot you want to control:",
                    "Pick Robot ID", JOptionPane.INFORMATION_MESSAGE, null,
                    robots, robots[0]);
        ...
        bRobotMove.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (bRobot.getText().equals("Robot ID: NONE")) {
                    JOptionPane.showMessageDialog(null,
                        "Please select ROBOT using ROBOT button first!",
                        "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                String input = JOptionPane.showInputDialog(
                    "How many pixels to move?", "" + move);
                
                try {
                    move = Integer.valueOf(input);
                } catch (NumberFormatException nfe) {
                    JOptionPane.showMessageDialog(null, "Cannot understand "
                        + input + " as integer!", "Error",
        ...
        bRobotTurn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String input = JOptionPane
                    .showInputDialog(
                        "How many degrees to turn anticlockwise (left)?", ""
                            + turn);
        ...
        JButton bRobotTurnTowardsFirstThing = new JButton(
            "TURN TOWARDS FIRST THING");
        ...
        JButton bRobotTurnTowardsFirstBox = new JButton(
            "TURN TOWARDS FIRST BOX");
        ...
        miLoadProgram.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!world.validWorldLoaded()) {
                    JOptionPane.showMessageDialog(null,
                        "Cannot load program, since no world is loaded!",
                        "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                String selectedRobot = (String) JOptionPane.showInputDialog(
                    null, "Select which robot to load a program for:",
                    "Pick Robot ID", JOptionPane.INFORMATION_MESSAGE, null,
                    robots, robots[0]);
                ...
                if (selectedRobot != null) {
                    ...
                    if (chooser.showOpenDialog(frame) == JFileChooser.APPROVE_OPTION)
                        world.loadProgram(chooser.getSelectedFile().getPath(),
                            Integer.valueOf(selectedRobot.substring(10)),
                            panel.getGraphics());
                }
            }
        });
        ...
        JMenuItem miExecuteProgram = new JMenuItem("Execute Program",
            KeyEvent.VK_E);
        miExecuteProgram.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!world.validWorldLoaded()) {
                    JOptionPane.showMessageDialog(null,
                        "Cannot execute program, since no world is loaded!",
                        "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                
                ArrayList<Integer> validRIDs = world
                    .getRobotIDsWithValidProgramsLoaded();
                if (validRIDs.size() == 0) {
                    JOptionPane.showMessageDialog(null,
                        "No robots have programs loaded!", "Error",
                        JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                String selectedRobot = (String) JOptionPane.showInputDialog(
                    null, "Select which robot to execute the program for:",
                    "Pick Robot ID", JOptionPane.INFORMATION_MESSAGE, null,
                    robots, robots[0]);
